...
Can be set to give the user a fuller description of the error. This is the same meaning than \hyperlink{class_q_message_box}{Q\+Message\+Box}, and is used the same way in mdt\+Error\+Dialog.
