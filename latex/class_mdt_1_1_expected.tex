...
\begin{DoxyCode}
\textcolor{keywordtype}{int} compute(\textcolor{keywordtype}{int} \hyperlink{class_mdt_1_1_expected_a744546093eb011f8d3964d749a3cbea3}{value});
\end{DoxyCode}


Using all together could be\+: 
\begin{DoxyCode}
\textcolor{keyword}{const} \textcolor{keyword}{auto} x = readValue(\textcolor{stringliteral}{"/path/to/x.csv"});
\textcolor{keywordflow}{if}(!x)\{
  \textcolor{comment}{// Error handling}
  \textcolor{keywordflow}{return} -1;
\}
\textcolor{keyword}{const} \textcolor{keyword}{auto} y = compute(*x);
\end{DoxyCode}
...
\index{Mdt\+::\+Expected@{Mdt\+::\+Expected}!operator$\ast$@{operator$\ast$}}
\index{operator$\ast$@{operator$\ast$}!Mdt\+::\+Expected@{Mdt\+::\+Expected}}
\subsubsection[{\texorpdfstring{operator$\ast$()\&}{operator*()&}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ T\& {\bf Mdt\+::\+Expected}$<$ T $>$\+::operator$\ast$ (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{class_mdt_1_1_expected_a6aab8021eae1bd2e24bf42aad0fab67e}{}\label{class_mdt_1_1_expected_a6aab8021eae1bd2e24bf42aad0fab67e}
...
\index{Mdt\+::\+Expected@{Mdt\+::\+Expected}!operator$\ast$@{operator$\ast$}}
\index{operator$\ast$@{operator$\ast$}!Mdt\+::\+Expected@{Mdt\+::\+Expected}}
\subsubsection[{\texorpdfstring{operator$\ast$() const \&}{operator*() const &}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ const T\& {\bf Mdt\+::\+Expected}$<$ T $>$\+::operator$\ast$ (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{class_mdt_1_1_expected_aaf11786a3d1fdb6ae8deb71639d83c29}{}\label{class_mdt_1_1_expected_aaf11786a3d1fdb6ae8deb71639d83c29}
